...
public interface ProteinMainUenoRepository
		extends JpaRepository<ProteinMainUeno, Long>, JpaSpecificationExecutor<ProteinMainUeno> {
	...
	@Transactional
	@Modifying
	@Query("UPDATE ProteinMainUeno SET delFlg=1 WHERE id = :id")
	...
	@Transactional
	@Modifying
	@Query("DELETE FROM ProteinMainUeno WHERE id IN(:ids)")
