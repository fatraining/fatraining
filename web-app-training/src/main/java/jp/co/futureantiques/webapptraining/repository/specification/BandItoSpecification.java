...
/**
 * BandMainItoの検索条件を生成するクラス
 *
 * @author future
 */
public class BandItoSpecification {
	/**
	 * 検索条件生成の実装
	 *
	 * @param BandItoSearchForm form
	 * @return BandMainItoのSpecification
	 */

	public static Specification<BandMainIto> generateBandSpecification(final BandItoSearchForm form) {
		return new Specification<BandMainIto>() {
			@Override
			public Predicate toPredicate(Root<BandMainIto> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
