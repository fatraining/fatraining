...
INSERT INTO `boowy_main_waki` VALUES (1,'ホンキー・トンキー・クレイジー','1985/6/1',2,'3:35',2,'ファースト・シングル。ライブの最後に流れるとテンションが上がるやつ。','0','2019-12-04','2019-12-04'),(2,'BAD FEELING','1985/8/22',1,'4:31',2,'セカンド・シングル。聞くとGOOD FEELINGになるよ。','0','2019-12-04','2019-12-04'),(3,'わがままジュリエット','1986/2/1',2,'4:34',2,'ミュージックビデオの女の子がかわいい。ヒムロックはずっとかっこいい。','0','2019-12-04','2019-12-04'),(4,'B・BLUE','1986/9/29',1,'3:57',2,'最初の曲名は「TRUE BLUE」だったけど、マドンナが同じ曲名で先にリリースしちゃったから変更された。','0','2019-12-04','2019-12-04'),(5,'ONLY YOU','1987/4/6',1,'4:11',2,'カラオケで合いの手入れるのが定番。','0','2019-12-04','2019-12-04'),(6,'Marionette-マリオネット-','1987/7/22',1,'3:37',2,'アニメーションで仕上げたミュージックビデオがダサい。でもそこがいい。','0','2019-12-04','2019-12-04'),(7,'季節が君だけを変える','1987/10/26',2,'4:06',1,'事実上最後のシングル曲。','0','2019-12-04','2019-12-04'),(8,'DAKARA','1988/2/3',1,'3:51',3,'初期の曲。改名前の「氷室狂介」名義で作詞。','0','2019-12-04','2019-12-04'),(9,'INSTANT VOVE','1988/3/25',1,'3:22',3,'乾いた恋愛感情をテーマにした曲。インスタントラーメン的な。','0','2019-12-04','2019-12-04'),(10,'OH! MY JULLY Part Ⅰ','1988/3/25',2,'4:06',3,'「ジュリー」は当時ヒムロックが飼っていたうさぎの名前。','0','2019-12-04','2019-12-04'),(11,'MY HONEY','1988/4/25',2,'5:03',3,'上目づかいが可愛すぎるからやめてほしいやつ。','0','2019-12-04','2019-12-04'),(12,'FUNNY-BOY','1988/4/25',1,'4:30',4,'ヒムロックが19歳の時に作った曲。生きてるだけじゃNO！','0','2019-12-04','2019-12-04'),(13,'IMAGE DOWN','1982/3/21',1,'3:03',3,'気が付けば口ずさんでいる曲1位。','0','2019-12-04','2019-12-04'),(14,'NO N.Y.','1982/3/21',1,'3:31',5,'女神のような顔で花をちぎるやつ。','0','2019-12-04','2019-12-04'),(15,'ON MY BEAT','1982/3/21',1,'2:19',3,'やたらと計算するのは棺桶に近くなってからでも十分できるらしい。','0','2019-12-04','2019-12-04'),(16,'LONDON GAME','1983/9/25',1,'3:28',3,'ロンドンゲームがどんなゲームなのかは不明。','0','2019-12-04','2019-12-04'),(17,'DREAMIN\'','1985/6/21',1,'4:05',6,'夢を見ている奴らに贈る曲。','0','2019-12-04','2019-12-04'),(18,'ハイウェイに乗る前に','1985/6/21',1,'3:44',7,'高速道路を走るときにかけたい曲1位。','0','2019-12-04','2019-12-04'),(19,'CLOUDY HEART','1985/6/21',2,'4:29',2,'地味に歌うのが難しい曲1位。','0','2019-12-04','2019-12-04'),(20,'JUSTY','1986/3/1',1,'3:57',2,'謎な歌詞が多いBOOWYの曲の中でも、特に謎な歌詞。','0','2019-12-04','2019-12-04'),(21,'DRAMATIC?DRASTIC!','1986/11/8',1,'4:17',8,'仮タイトルは「トーキング・ヘッズは3時のおやつ」。','0','2019-12-04','2019-12-04'),(22,'SUPER-CALIFRAGILISTIC-EXPIARI-DOUCIOUS','1986/11/8',1,'3:00',7,'絶対曲名覚えられないやつ。曲の間奏でモーツァルトが流れたりするやつ。','0','2019-12-04','2019-12-04'),(23,'ＭＯＲＡＬ','1987/12/01',NULL,'04:29',3,'パンク。','1','2019-12-16','2019-12-16');
...
-- Dump completed on 2019-12-18  9:50:21
