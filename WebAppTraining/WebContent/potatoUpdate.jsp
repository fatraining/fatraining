...
<body class="container">
	...
	<div class="text-right">
		...
		さん <a href="potatoSearch.action">Back</a>
	</div>
	<br />
	...
	<s:form cssClass="form-horizontal">
		...
		<div class="form-group">
			<label class="col-sm-3 control-label"> 内容量(g) </label>
			<div class="col-sm-7">
				<s:textfield cssClass="form-control" name="volume"></s:textfield>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<s:textfield cssClass="form-control" name="price"></s:textfield>
				<p class="help-block">※半角数字で入力してください</p>
			</div>
		</div>
		<br />
