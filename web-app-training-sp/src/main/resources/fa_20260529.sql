...
--
-- Table structure for table `analog_main_noguchi`
--

DROP TABLE IF EXISTS `analog_main_noguchi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `analog_main_noguchi` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
  `analog_title` varchar(256) NOT NULL,
  `type_id` int(3) NOT NULL,
  `target_years` int(3) NOT NULL,
  `genre1_id` int(11) DEFAULT NULL,
  `genre2_id` int(11) DEFAULT NULL,
  `play_person` varchar(256) DEFAULT NULL,
  `play_time` varchar(256) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`),
  KEY `genre1_id` (`genre1_id`),
  KEY `genre2_id` (`genre2_id`),
  CONSTRAINT `analog_main_noguchi_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `type_noguchi` (`id`),
  CONSTRAINT `analog_main_noguchi_ibfk_2` FOREIGN KEY (`genre1_id`) REFERENCES `genre1_noguchi` (`id`),
  CONSTRAINT `analog_main_noguchi_ibfk_3` FOREIGN KEY (`genre2_id`) REFERENCES `genre2_noguchi` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `analog_main_noguchi`
--

LOCK TABLES `analog_main_noguchi` WRITE;
/*!40000 ALTER TABLE `analog_main_noguchi` DISABLE KEYS */;
INSERT INTO `analog_main_noguchi` VALUES (1,'ito レインボー',1,8,4,5,'2-14人','5-15分','価値観を共有して数字を言葉で表現する協力コミュニケーションゲーム。お題の言い換えで仲間と感覚を合わせるのが楽しい。','0','2026-03-01 00:00:00','2026-05-25 09:32:43'),(2,'ナンジャモンジャ',1,4,7,15,'2-6人','15分','名前をつけたキャラが再登場したら即座に名前を叫ぶ反射系。記憶とスピードが試される。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(3,'はぁっていうゲーム',1,8,5,8,'3-8人','15分','同じ言葉を“演技”だけで伝えるコミュニケーション系。声と表情だけで当ててもらう大喜利寄りのゲーム。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(4,'ザ・マインド',1,8,4,0,'2-4人','20分','数字カードを“会話なし”で昇順に出す協力ゲーム。気持ちを合わせる不思議な体験が魅力。','0','2026-03-01 00:00:00','2026-05-21 17:09:59'),(5,'ペンギンパーティ',1,6,11,12,'2-6人','15分','同じ色をつなげてピラミッドを作るシンプルなカードゲーム。手札管理とゴーアウトが重要。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(6,'ごきぶりポーカー',1,8,1,9,'2-6人','20-30分','嫌なカードを押し付け合うブラフゲーム。嘘をつく・見抜く心理戦が中心。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(7,'クイックショット',1,8,3,9,'1-7人','5-10分','全4ラウンドの戦いで生き残り、最強を目指すシューティング・カードゲーム。バッティング要素もあり、どのカードを出すかの緊張感が魅力。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(8,'ナナトリドリ',1,6,11,12,'2-6人','10-20分','先に手札がなくなったプレイヤーが勝者。大富豪のようだが前のカードを回収し、強化することも可能。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(9,'ガンナガン',1,12,13,NULL,'2人','10-30分','二丁拳銃で撃ち合う対戦カードゲーム。デッキ構築とスキルを使いこなす読み合いが熱い。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(10,'インサイダー',1,9,2,4,'4-8人','15分','質問で答えを探す中に“内通者”が紛れている正体隠匿。協力と疑いが交錯する心理戦。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(11,'犯人は踊る',1,8,2,11,'3-8人','10分','犯人カードが手札で移動する推理＆ブラフゲーム。誰が犯人を持っているか読み合う。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(12,'人狼ドッチ',1,10,2,5,'3-8人','5-10分','役職が二枚存在し、そのうち伏せカードがあるため、どこに人狼が隠れているのかを推理する正体隠蔽ゲーム。ある役職では伏せカードと交換するものも。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(13,'コヨーテ',1,10,3,NULL,'2-10人','15-30分','自分だけ見えない数字の合計を推測するブラフ系。ハッタリと計算が重要。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(14,'五本のキュウリ',1,8,3,9,'2-6人','25分','最後のトリック（ラウンド）を取りたくない逆トリテ。シンプルだが読み合いが深い。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(15,'ハゲタカのえじき',1,7,3,11,'2-6人','15分','数字を同時出しするバッティング系。欲しい点数を巡る読み合いが熱い。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(16,'二ムト',1,8,3,11,'2-10人','30分','出したカードが列に入るバッティング系。“6枚目”を取らないようにする駆け引き。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(17,'UNO',1,7,12,0,'2-10人',NULL,'色か数字を合わせて手札をなくすゴーアウト系。特殊カードで逆転が起きやすい。','0','2026-03-01 00:00:00','2026-05-21 17:16:39'),(18,'Neu',1,7,11,NULL,'2-7人','10-20分','小さい数字から出していき、101以上を超えてはいけないハンドマネジメント系。運と読み合いが白熱する。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(19,'トマトマト',1,6,7,NULL,'3-6人','20分','早口言葉を読むパーティーゲーム。噛んだら負けの言葉遊び系。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(20,'テストプレイなんてしてないよ',1,13,9,NULL,'2-10人','1-5分','理不尽な効果で即勝利・即敗北するカオスゲーム。ルールよりノリが大事。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(21,'はらぺこバハムート',1,10,13,NULL,'2人','10分','かわいい絵柄のカードを駆使し、相手のライフを削る対戦型カードゲーム。どう相手を倒すか、戦略の幅は広がっていく。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(22,'ザ・ゲーム',1,8,4,12,'1-5人','15-20分','数字を協力して並べる協力カードゲーム。会話制限がある中で連携する。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(23,'ナナ',1,6,7,10,'2-5人','15-30分','同じ数字を3枚集めるセットコレクション。記憶と推理が必要。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(24,'ラマ',1,8,12,NULL,'2-6人','20分','手札を減らすゴーアウト系。出せないときの判断が勝敗を分ける。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(25,'CuBirds(キューバーズ)',1,8,10,NULL,'2-5人','20分','鳥を集めてセットを作るカードゲーム。場のカード操作が重要。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(26,'ウミガメのスープ',2,10,5,NULL,'2人以上','10-15分','水平思考クイズ。質問を重ねて真相にたどり着く。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(27,'音速飯店',2,6,12,15,'2-6人','15分','中華料理の名前を早く作るスピード系。語感と反射神経が勝負。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(28,'ストライク',2,8,15,NULL,'2-5人','15分','サイコロを投げ入れて同じ目を狙うダイスゲーム。運と度胸が試される。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(29,'SKULL（スカル）',2,10,1,NULL,'3-6人','30分','花かドクロを伏せてブラフする心理戦。度胸試しと読み合いが魅力。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(30,'おばけキャッチ',2,8,7,15,'2-8人','30分','イラストと一致するアイテムを瞬時に取る反射系。スピードと判断力が必要。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(31,'Xing（バッティング）',2,13,3,NULL,'2-6人','15分','宝石を取り合うバッティング系ゲーム。相手が持っている宝石も略奪できるかも。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(32,'Blokus(ブロックス)',2,7,19,20,'2-4人','15-20分','自分の色のブロックを置いて陣地を広げる抽象戦略。相手の動きを封じるのが鍵。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(33,'人生ゲーム',2,6,5,0,'2-6人',NULL,'ルーレットで人生を進めるすごろく系。運要素が強いファミリーゲーム。','0','2026-03-01 00:00:00','2026-05-22 14:39:18'),(34,'ウボンゴ',2,8,19,NULL,'1-4人','25分','パズルを早く完成させるスピード×パズル。直感と空間把握が重要。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(35,'ダイイングメッセージ',2,15,2,5,'4-15人','15分','犯人を示すダイイングメッセージを作成し、そのメッセージを解読する推理ゲーム。被害者の情報をもとに、犯人を見つけることができるのか。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(36,'チャオチャオ．．!',2,8,1,16,'2-4人','25-30分','嘘をついて橋を渡るブラフゲーム。バレたら落ちる緊張感が楽しい。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(37,'ワンナイト人狼',2,10,2,NULL,'3-7人','10分','1夜で決着する正体隠匿ゲーム。短時間で濃い心理戦。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(38,'チーズは誰が食べた？',2,8,2,16,'4-8人','10-15分','ダイスの目で予測し、チーズを盗んだ　ネズミ（人狼）を見つける正体隠蔽ゲーム。同じ目が出たら、共犯になることも。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(39,'嘘月は誰',2,6,1,12,'2人以上','5-20分','日本に古くから伝わる月の呼び名をテーマにした新感覚のダウトゲーム。数字だけではなく、月の名前からも推理し、?月を暴け。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(40,'BAMBOREO（バンボレオ）',2,6,14,NULL,'2-6人','10-20分','揺れる台から木片を取るバランスゲーム。物理的な緊張感が魅力。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(41,'九九×ジャン',2,6,17,NULL,'2-4人','10-15分','九九で使用した麻雀。とても簡単で、九九や麻雀のことを理解しやすくなる。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(42,'六華',2,8,17,NULL,'2-5人','10-20分','花火の絵柄を使った麻雀。上下の花火の絵柄から判断し、役を完成させろ。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(43,'コードネーム',2,10,1,4,'4-8人','15分','ヒントで仲間に単語を当ててもらうワード系。連想力とチームワークが鍵。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(44,'Splendor',3,10,18,NULL,'2-4人','30分','宝石を集めてエンジンを作る拡大再生産。効率化と先読みが重要。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(45,'カタン',3,8,18,NULL,'3-4人','60分','資源を交換して島を開拓する王道ボードゲーム。交渉と戦略が中心。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(46,'街コロ',2,7,16,18,'2-5人','30分','サイコロで資源を得て街を発展させる拡大再産。建物の組み合わせが戦略。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(47,'PANDEMIC（パンデミック）',3,8,4,18,'2-4人','45分','世界の感染症を協力して防ぐ協力ゲーム。役割分担と計画性が重要。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(48,'algo（アルゴ）',4,6,17,NULL,'1-4人','5-10分','数字の並びを推理する論理ゲーム。情報公開と推理が勝負。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(49,'もっふぁ。',4,10,17,NULL,'2人','20-30分','もっふぁを動かす三目並べをする中小戦略。しかし、もっふぁを置くと、周りの駒も吹き飛ばしてしますぞ。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(50,'ガイスター',4,8,17,NULL,'2人','10-20分','お化けの駒を動かす2人用心理戦。相手の意図を読むのが重要。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(51,'ゴブレットゴブラーズ',4,6,17,NULL,'2人','5分','大中小の駒で三目並べをする抽象戦略。駒を“かぶせる”のが特徴。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(52,'Look　Me',4,5,17,NULL,'2人','15分','視線を操作しながら自分のコマ同士を「目を合わせる」ことを目指す3D戦略。空間認識や論理的思考力を育むことができる。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(53,'あいうえバトル',4,6,6,NULL,'2-5人','15分','各々お題を出し、ひらがな一文字指定し、お題を当てていく推理ゲーム。相手にばれず当てていく読み合いと緊張感が醍醐味。','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(56,'大富豪',1,5,0,0,NULL,NULL,'','0','2026-05-22 16:36:28','2026-05-22 16:36:28'),(58,'大富豪',2,12,15,0,NULL,NULL,'','1','2026-05-25 10:20:51','2026-05-25 10:20:51');
/*!40000 ALTER TABLE `analog_main_noguchi` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `genre1_noguchi`
--

DROP TABLE IF EXISTS `genre1_noguchi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `genre1_noguchi` (
  `id` int(3) NOT NULL,
...
--
-- Dumping data for table `genre1_noguchi`
--

LOCK TABLES `genre1_noguchi` WRITE;
/*!40000 ALTER TABLE `genre1_noguchi` DISABLE KEYS */;
INSERT INTO `genre1_noguchi` VALUES (0,NULL,'0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(1,'心理戦（ブラフ）','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(2,'心理戦（正体隠蔽）','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(3,'心理戦（バッティング）','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(4,'協力','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(5,'コミュニケーション','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(6,'言葉遊び','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(7,'記憶','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(8,'大喜利','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(9,'トリックテイキング系','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(10,'セットコレクション系','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(11,'ハンドマネジメント系','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(12,'ゴーアウト系','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(13,'デッキ構築','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(14,'バランス','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(15,'スピード','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(16,'ダイス','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(17,'抽象戦略','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(18,'拡大再生産','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(19,'パズル','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(20,'陣取り','0','2026-03-01 00:00:00','2026-03-01 00:00:00');
/*!40000 ALTER TABLE `genre1_noguchi` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `genre2_noguchi`
--

DROP TABLE IF EXISTS `genre2_noguchi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `genre2_noguchi` (
  `id` int(3) NOT NULL,
  `genre` varchar(256) DEFAULT NULL,
  `del_flg` varchar(1) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
...
--
-- Dumping data for table `genre2_noguchi`
--

LOCK TABLES `genre2_noguchi` WRITE;
/*!40000 ALTER TABLE `genre2_noguchi` DISABLE KEYS */;
INSERT INTO `genre2_noguchi` VALUES (0,NULL,'0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(1,'心理戦（ブラフ）','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(2,'心理戦（正体隠蔽）','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(3,'心理戦（バッティング）','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(4,'協力','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(5,'コミュニケーション','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(6,'言葉遊び','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(7,'記憶','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(8,'大喜利','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(9,'トリックテイキング系','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(10,'セットコレクション系','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(11,'ハンドマネジメント系','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(12,'ゴーアウト系','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(13,'デッキ構築','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(14,'バランス','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(15,'スピード','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(16,'ダイス','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(17,'抽象戦略','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(18,'拡大再生産','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(19,'パズル','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(20,'陣取り','0','2026-03-01 00:00:00','2026-03-01 00:00:00');
/*!40000 ALTER TABLE `genre2_noguchi` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `type_noguchi`
--

DROP TABLE IF EXISTS `type_noguchi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `type_noguchi` (
  `id` int(3) NOT NULL,
  `type` varchar(256) DEFAULT NULL,
  `del_flg` varchar(1) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
...
--
-- Dumping data for table `type_noguchi`
--

LOCK TABLES `type_noguchi` WRITE;
/*!40000 ALTER TABLE `type_noguchi` DISABLE KEYS */;
INSERT INTO `type_noguchi` VALUES (0,NULL,'0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(1,'カードゲーム','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(2,'パーティーゲーム','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(3,'ボードゲーム','0','2026-03-01 00:00:00','2026-03-01 00:00:00'),(4,'その他','0','2026-03-01 00:00:00','2026-03-01 00:00:00');
/*!40000 ALTER TABLE `type_noguchi` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-29 14:47:22
