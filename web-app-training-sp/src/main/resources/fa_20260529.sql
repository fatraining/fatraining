...
--
-- Table structure for table `compatible_model_ikeda`
--

DROP TABLE IF EXISTS `compatible_model_ikeda`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `compatible_model_ikeda` (
  `id` int(11) NOT NULL,
  `compatible_model` varchar(256) DEFAULT NULL,
  `del_flg` varchar(1) DEFAULT NULL,
  `create_date` datetime NOT NULL,
  `update_date` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `compatible_model_ikeda`
--

LOCK TABLES `compatible_model_ikeda` WRITE;
/*!40000 ALTER TABLE `compatible_model_ikeda` DISABLE KEYS */;
INSERT INTO `compatible_model_ikeda` VALUES (0,NULL,'0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(1,'ファミリーコンピュータ','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(2,'ゲームボーイ','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(3,'スーパーファミコン','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(4,'NINTENDO 64','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(5,'GBカラー','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(6,'GBA','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(7,'ゲームキューブ','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(8,'DS','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(9,'Wii','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(10,'3DS','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(11,'Wii U','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(12,'Switch','0','2026-05-15 00:00:00','2026-05-20 00:00:00');
/*!40000 ALTER TABLE `compatible_model_ikeda` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `genre_ikeda`
--

DROP TABLE IF EXISTS `genre_ikeda`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `genre_ikeda` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `genre_ikeda`
--

LOCK TABLES `genre_ikeda` WRITE;
/*!40000 ALTER TABLE `genre_ikeda` DISABLE KEYS */;
INSERT INTO `genre_ikeda` VALUES (0,NULL,'0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(1,'2D見下ろし型・謎解き','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(2,'3D・オープンワールド','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(3,'その他・横スクロール','0','2026-05-15 00:00:00','2026-05-20 00:00:00');
/*!40000 ALTER TABLE `genre_ikeda` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `time_series_ikeda`
--

DROP TABLE IF EXISTS `time_series_ikeda`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `time_series_ikeda` (
  `id` int(11) NOT NULL,
  `time_series` varchar(256) DEFAULT NULL,
  `del_flg` varchar(1) DEFAULT NULL,
  `create_date` datetime NOT NULL,
  `update_date` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `time_series_ikeda`
--

LOCK TABLES `time_series_ikeda` WRITE;
/*!40000 ALTER TABLE `time_series_ikeda` DISABLE KEYS */;
INSERT INTO `time_series_ikeda` VALUES (0,NULL,'0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(1,'天地創造','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(2,'ハイラル王国建国','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(3,'ハイラル統一戦争','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(4,'時のオカリナで勇者勝利(大人時代)・ハイラル水没','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(5,'時のオカリナで勇者勝利(大人時代)・新生ハイラル王国建国','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(6,'時のオカリナで勇者勝利(子ども時代)','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(7,'時のオカリナで勇者敗北・封印戦争','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(8,'時のオカリナで勇者敗北・ハイラル王国衰退','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(9,'その他(独立ルート)','0','2026-05-15 00:00:00','2026-05-20 00:00:00');
/*!40000 ALTER TABLE `time_series_ikeda` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `zelda_main_ikeda`
--

LOCK TABLES `zelda_main_ikeda` WRITE;
/*!40000 ALTER TABLE `zelda_main_ikeda` DISABLE KEYS */;
INSERT INTO `zelda_main_ikeda` VALUES (1,'スカイウォードソード',2,1,9,2011,'全ゼルダシリーズの原点。','0','2026-05-15 00:00:00','2026-05-27 17:06:21'),(2,'ふしぎのぼうし',1,2,6,2001,'ハイラル王国建国初期の話。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(3,'4つの剣',1,2,6,2004,'リンクが4人に分身する。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(4,'時のオカリナ',2,3,4,1998,'BOSS戦の結果から展開が3つに分岐する。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(5,'神々のトライフォース',1,7,3,1991,'やることが多く上級者向けのゲーム。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(6,'夢を見る島',1,7,2,1993,'2019年にSwitchでリメイクされた。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(7,'ふしぎの木の実',1,7,5,2001,'「大地の章」「時空の章」と2作品に分かれて発売。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(8,'神々のトライフォース2',1,7,10,2013,'神々のトライフォースから数100年後の世界。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(9,'トライフォース3銃士',1,7,10,2015,'4つの剣同様に複数人でのマルチプレイ作品。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(10,'知恵のかりもの',1,7,12,2024,'ゼルダ姫が主人公となり冒険する。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(11,'ゼルダの伝説',1,8,1,1986,'ゼルダシリーズ第1作品目。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(12,'リンクの冒険',3,8,1,1987,'第2作品目にして唯一横スクロールアクションがある。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(13,'ムジュラの仮面',2,6,4,2000,'ゲーム内3日間でクリアしないとゲームオーバー。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(14,'トワイライトプリンセス',2,6,9,2006,'ゲームが得意な人は始めやすいゼルダ。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(15,'4つの剣+',1,6,7,2004,'子どもリンクが活躍する最後の世界線。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(16,'風のタクト',2,4,7,2002,'風を自在に操る指揮棒を利用して物語を進めていく。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(17,'夢幻の砂時計',1,4,8,2007,'風のタクト続編。DSのタッチペン操作懐かしい。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(18,'大地の汽笛',1,5,8,2009,'ゼルダ姫が幽体離脱する。そのまま一緒に冒険。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(19,'ゼルダ無双',2,9,11,2014,'めちゃくちゃ敵を倒す爽快アクションゲーム。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(20,'ゼルダ無双　厄災の黙示録',2,9,12,2020,'ブレスオブザワイルドの100年前の世界戦。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(21,'ブレスオブザワイルド',2,9,12,2017,'シリーズ初のオープンワールド。めっちゃ売れた。','0','2026-05-15 00:00:00','2026-05-20 00:00:00'),(22,'ティアーズオブザキングダム',2,9,12,2023,'武器や道具を組み合わせて新たに物を作れる。','0','2026-05-15 00:00:00','2026-05-29 10:12:20'),(54,'aaaa',0,0,0,2030,'','0','2026-05-29 11:32:01','2026-05-29 11:32:01');
/*!40000 ALTER TABLE `zelda_main_ikeda` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-29 14:14:53
