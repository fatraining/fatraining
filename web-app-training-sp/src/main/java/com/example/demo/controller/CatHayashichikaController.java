...
public class CatHayashichikaController {
	...
	public String insertCat(@ModelAttribute @Validated final CatHayashichikaInputForm form, final BindingResult bindingResult) {
	...
	/**
	 * CatMainテーブルのレコードを倫理削除して検索画面に遷移する
	 * 
	 * @param long id
	 * @return 検索画面のパス
	 */
	...
	/**
	 * CatMainのテーブルデータを完全削除して検索画面に遷移する
	 * 
	...
	public String deleteCompCat(@Validated final CatHayashichikaDeleteForm form,final BindingResult bindingResult,final Model model) {
		if(bindingResult.hasFieldErrors()) {
