...
--
-- Host: 127.0.0.1
-- Generation Time: 2015 年 5 朁E07 日 04:04
-- サーバのバージョン： 5.6.21
-- PHP Version: 5.6.3
...
INSERT INTO `table_color` (`id`, `color`, `day`, `new_day`, `userid`, `new_userid`, `time_stamp`, `delete`) VALUES
...
INSERT INTO `table_like` (`id`, `name`, `food`, `drink`, `colorNm`, `day`, `new_day`, `userid`, `new_userid`, `time_stamp`, `delete`) VALUES
(1, '林', 'ピザ', 'コーラ', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '瀬守', 'カレー', '水', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '田中', 'サンドイッチ', 'オレンジジュース', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '岡田', '煮物', 'お茶', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(5, '橘', 'ピザ', 'レモネード', 1, NULL, NULL, NULL, NULL, NULL, NULL);
