...
--
-- Host: 127.0.0.1
-- Generation Time: 2015 年 4 朁E23 日 14:50
-- サーバのバージョン： 5.6.21
-- PHP Version: 5.6.3
...
(1, 'Fate/stay night', 1, '4/21', '4/21', 'ShirouEmiya', '1', 'Blade Works', 'Sword'),
...
(1, 'Fate', '4/21', '4/21', 'ShirouEmiya', '1', 'Blade Works', 'Sword'),
...
--
ALTER TABLE `like_game`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'AUTO_INCERMENT',AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `like_series`
--
ALTER TABLE `like_series`
MODIFY `i` int(11) NOT NULL AUTO_INCREMENT COMMENT 'AUTO_INCREMENT',AUTO_INCREMENT=5;
