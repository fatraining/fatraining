...
<html>
	...
	%>
	<body style="background-color:#f0e68c" onLoad="document.tmLogin.memberId.focus()">
	<%
	} else {
	%>
	...
	%>
		<div id="headerArea">
			<h2 align="center">
				<Marquee width="50%" behavior="scroll" scrollamount="50" scrolldelay="50">∠●_●；ショップ　☆彡</Marquee>
			</h2>
		</div>
		...
		<s:form cssClass="form-horizontal">
			<div class="form-group" style="margin-top:10px" align="center">
				<div style="margin-left:28px">
					会員ID ： <font size="4"><s:textfield name="memberId" size="30"/></font>
				</div>
			</div>
			...
			<div class="form-group" style="margin-top:10px" align="center">
				<div>
	 			...
	 			<div class="form-group" align="center">
					<s:submit cssClass="button" method="login" value="ログイン" cssStyle="margin-top:10px;" />
					<s:submit cssClass="button" method="back" value="戻る" cssStyle="margin-top:10px;" />
				</div>
			</div>
			...
			<div class="form-group" style="margin-top:10px" align="center">
				<div>
					<nobr><label><font color="ff0000" size="3">会員でない方ははこちら</font></label></nobr>
				</div>
	 			<div class="form-group" align="center" style="margin-top:7px">
					<s:submit cssClass="button" method="registration" value="会員登録"/>
			...
			<div class="form-group" style="margin-top:10px" align="center">
				<div>
					<nobr><label><font color="ff0000" size="3">会員登録はこちら</font></label></nobr>
				</div>
	 			<div class="form-group" align="center" style="margin-top:7px">
					<s:submit cssClass="button" method="registration" value="会員登録"/>
	 			</div>
