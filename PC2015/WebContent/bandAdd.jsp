...
<s:form cssClass="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-md-3">
			<s:textfield name="band_name" cssClass="form-control" rows="10" maxlength="50" />
		</div>
	...
	<hr/>
		...
		<div class="col-md-3">
			<s:textfield name="sex" cssClass="form-control" rows="10" maxlength="50" />
		</div>
		<label class="col-sm-2 control-label">年齢</label>
		<div class="col-md-3">
			<s:textfield name="age" cssClass="form-control" rows="10" maxlength="50" />
		</div>
	<br/><br/><br/>
	<hr/>
		<label class="col-sm-2 control-label">出身校</label>
		<div class="col-md-3">
			<s:textfield name="school" cssClass="form-control" rows="10" maxlength="50" />
		</div>
		<label class="col-sm-2 control-label">好きな曲</label>
		<div class="col-md-3">
			<s:textfield name="favorite_song" cssClass="form-control" rows="10" maxlength="50" />
		</div>
	<br/><br/><br/>
	<hr/>
		<label class="col-sm-2 control-label">演奏楽器</label>
		<div class="col-md-3">
			<s:textfield name="part" cssClass="form-control" rows="10" maxlength="50" />
		</div>
		<br />
		<hr />
	</div>
