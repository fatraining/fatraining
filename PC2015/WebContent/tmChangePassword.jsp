...
<html>
	...
	<body style="background-color:#f0e68c" onLoad="document.tmChangePassword.oldPassword.focus()">
		<div id="headerArea">
			<h2 align="center">
				<Marquee behavior="slide" width="50%" scrolldelay="50">∠●_●；ショップ　☆彡</Marquee>
			</h2>
		...
		<s:form cssClass="form-horizontal">
			...
			<table border="1" cellpadding="3" align="center" style="font-size:16px;">
				<tr>
					<td class="rowheader">現在のパスワード</td>
					<td class="input" align="center" colspan="2"><small>変更前のパスワードを入力してください</small><br>
							<s:textfield name="oldPassword" type="password" onkeyDown="return hanAlpha()" cssStyle="ime-mode:disabled" maxlength="12"/></td>
				</tr>
				<tr>
					<td class="rowheader">新しいパスワード</td>
					<td class="input" align="center" colspan="2"><small>半角英数字4文字以上12文字以内で入力してください</small><br>
							<s:textfield name="newPassword" type="password" onkeyDown="return hanAlpha()" cssStyle="ime-mode:disabled" maxlength="12"/></td>
				</tr>
				<tr>
					<td class="rowheader">新しいパスワード確認用</td>
					<td class="input" align="center" colspan="2"><small>確認のため、もう一度同じパスワードを入力してください</small><br>
							<s:textfield name="newPassword2" type="password" onkeyDown="return hanAlpha()" cssStyle="ime-mode:disabled" maxlength="12"/></td>
				</tr>
			</table>
			<div align="center" style="margin-top:15px">
				<s:submit cssClass="button" method="change" value="変更" />
